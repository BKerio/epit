          ...
          {isSubmitted ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                ...
                className="w-full inline-flex items-center justify-center bg-gradient-to-r from-[#A87C1F] to-yellow-500 hover:from-yellow-600 hover:to-yellow-500 text-white font-semibold py-3 px-6 rounded-lg shadow-lg transition-all duration-300 disabled:opacity-50"
              >
                {isSubmitting ? (
